...
def seed_fields():
    ...
    main_header = Field(name="main_header", resume_html="""<div><div class="flex-horizontal-space_between"><h3>Full Name</h3><p>GitHub Link</p></div></div>""", form_html="""<div><input type="text" name="full_name" id="full_name" placeholder="Full Name" /><input type="text" name="github_link" id="github_link" placeholder="GitHub" /></div>""")
