...
const Preview = ({ template_name, template, values, preview, form, setValues, tags, currentStyle }) => {
  ...
  for (let i = 0; i < template.length; i++) {
    ...
    if(preview && !form){
        return (
            <>
                <div className={`bg-white ${currentStyle ? currentStyle[1] : 'text-black-1000'} ${currentStyle ? currentStyle[0] : 'font-mono'} p-2 h-auto`} id="resume-to-save">
