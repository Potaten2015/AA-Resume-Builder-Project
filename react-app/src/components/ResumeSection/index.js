    ...
    if(section.name.includes("header")){
        return (
            <div className="template-header-flex">
                {section.fields.map( field => <EditHelper field={field} form={form} value={values[field.order]} setValues={setValues} number={field.order} /> )}
            </div>
        )
            ...
            <div>
                ...
                <div className="experience-top-flex-outer">
                    <div className="experience-top-flex-left">
                        ...
                        }).map( field => <EditHelper field={field} form={form} value={values[field.order]} setValues={setValues} number={field.order} />  )}
                    </div>
